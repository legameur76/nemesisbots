...
client.login('NjE1MzAzMjMzODc4ODg0MzYy.XWe5ng.zdBz1MGlddSdz-1a7dOaviwkdl4')
 
client.on('guildMemberAdd', function (member) {
    let embed = new Discord.RichEmbed()
        .setDescription(':tada: **' + member.user.username + '** a rejoint ' + member.guild.name)
        .setFooter('Nous sommes désormais ' + member.guild.memberCount)
    member.guild.channels.get('613564140501336097').send(embed)
    member.addRole('613571092736507923')
})
...
client.on('guildMemberRemove', function (member) {
    let embed = new Discord.RichEmbed()
        ...
        .setFooter('Nous sommes désormais ' + member.guild.memberCount)
    member.guild.channels.get('615309209583616090').send(embed)
})
 
client.on('ready', function () {
    console.log('Bot connecté')
    client.user.setActivity('BruscaRoleplay', {type: "Joue à"})
})
